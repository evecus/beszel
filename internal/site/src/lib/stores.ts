...
/** Whether running in self-monitoring mode (single server, no manage UI) */
export const $selfMode = atom(false)

/** Whether self-mode requires password login */
export const $selfHasAuth = atom(false)
